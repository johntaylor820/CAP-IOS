...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    let color = UIColor(red: 29/255, green: 168/255, blue: 224/255, alpha: 1.0)
    
    @IBInspectable open var mentionColor: UIColor = UIColor(red: 29/255, green: 168/255, blue: 224/255, alpha: 1.0) {
        didSet { updateTextStorage(false) }
    }
    @IBInspectable open var mentionSelectedColor: UIColor? {
        didSet { updateTextStorage(false) }
    }
    @IBInspectable open var hashtagColor: UIColor = UIColor(red: 29/255, green: 168/255, blue: 224/255, alpha: 1.0) {
        didSet { updateTextStorage(false) }
    }
    @IBInspectable open var hashtagSelectedColor: UIColor? {
        didSet { updateTextStorage(false) }
    }
    @IBInspectable open var URLColor: UIColor = UIColor(red: 29/255, green: 168/255, blue: 224/255, alpha: 1.0)  {
        didSet { updateTextStorage(false) }
    }
    ...
    open var shouldShowAt: Bool = true
    ...
    fileprivate func updateTextStorage(_ parseText: Bool = true) {
        ...
        if !shouldShowAt {
            textStorage.mutableString.replaceCharacters(in: NSRange(location: 0, length: 1), with: "")
        }
